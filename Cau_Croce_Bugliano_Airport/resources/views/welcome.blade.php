    ...
    <header id="header" class="fixed-top d-flex align-items-cente">
      ...
      >
        <h1 class="logo me-auto me-lg-0">
          <a href="index.html">Bugliano Airport</a>
        </h1>
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="#menu">I servizi aeroportuali</a></li>
            <li><a class="nav-link scrollto" href="#specials">Contattaci</a></li>
          </ul>
          ...
          >
            <div class="row">
              <div class="col-lg-8">
                ...
                <div class="btns">
                  <a href="{{route('voli')}}" class="btn-menu animated fadeInUp scrollto"
                    >Le nostre rotte</a
                  >
                  <a
                    href="#book-a-table"
              ...
              >
                <a
                  href="https://www.youtube.com/watch?v=QC5cqgfPJNE&ab_channel=TEDxTalks"
...
<div class="container">
  <div class="copyright">
    &copy; Copyright <strong><span>Mattia Cau e Alice Croce </span></strong
    >- Esercitazione Aulab- Corso Laravel
  </div>
  <div class="credits">
